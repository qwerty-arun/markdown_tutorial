...
|rm|This command is used to delete a file and its contents within them. Caution:- Always be sure which directory you are in as this command will delete everything and there is no going back.<ul><li>rm <filename> to delete a file</li><li>rm file1 file2 file3.. to delete multiple files at once.</li><li>`rm* to delete all files` (Be very careful with this)</li><li>rm -r directory_name to delete a non-empty directory</li></ul> |
